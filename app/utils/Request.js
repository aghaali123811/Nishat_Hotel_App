...
const getRequest = async (url, params) => {
  console.log('yasir 1234 getRequest url',url,params)
  try {
...
const postRequest = async (url, params, isFormData, withToken) => {
  console.log('yasir 1234 postRequest url',url,params)
...
const putRequest = async (url, params) => {
  console.log('yasir 1234 putRequest url',url,params)
  const config = {
    headers: {
      'Content-Type': 'application/json',
    },
...
export const postRequestWithFile = async (url, parameters, withToken) => {
  console.log('yasir 1234 url postRequestWithFile',url,parameters)
  if (withToken) {
