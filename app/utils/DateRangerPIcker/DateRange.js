    ...
    return (
      <View>
          ...
          <View style={styles.calendar}>
            <View style={styles.headActionContainer}>
              <TouchableOpacity onPress={this.previousMonth}>
                <Icon name="left" style={{fontSize: RFValue(18)}} />
              </TouchableOpacity>
              <Text
                style={{
                  fontSize: 20,
                  color: 'black',
                  fontFamily: AppTheme.fonts.PFbold,
                }}>
                {this.state.focusedMonth.format('MMMM YYYY')}
              </Text>
              <TouchableOpacity onPress={this.nextMonth}>
                <Icon name="right" style={{fontSize: RFValue(18)}} />
              </TouchableOpacity>
            </View>
        ...
        {this.state.selectState === 'year' && (
          <View style={[styles.calendar, {justifyContent: 'center'}]}>
            <Picker
